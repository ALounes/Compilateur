		...
		case typeOperator:
			{
					...
					case OPER_ASSIGN:
               {
					...
					case OPER_WHILE:
						...
						currentLabel++;
                  fprintf(fout,"L_while_%d:\n",label1);
                  generateAsmExpression(n->t_oper.op[0],fout);
                  fprintf(fout,"\tjf Next_while_%d\n",label1);
                  generateAsmRec(n->t_oper.op[1],fout);
                  fprintf(fout, "\tjp L_while_%d\n", label1);
                  fprintf(fout, "Next_while_%d:\n", label1);
                  ...
                  if (n->t_oper.nOperands == 2 )  //Cas If/Then
                  {
                     fprintf(fout, "\tjf Next_if_%d\n", label1);
