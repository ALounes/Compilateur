...
typedef enum { OPER_ADD, OPER_SUB, OPER_MULT, OPER_DIV, OPER_WRITE, OPER_SKIP, OPER_SEQUENCE, OPER_RESERVE_SPACE, OPER_EGAL, OPER_INF, OPER_SUP, OPER_NOT_EGAL, OPER_SUP_EGAL, OPER_INF_EGAL } nodeOper;
